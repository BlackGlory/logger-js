...
export class TokenPolicyManager extends Base {
  ...
  async getNamespaces(options: ILoggerManagerRequestOptions = {}): Promise<string[]> {
    ...
    , appendPathname('/admin/logger-with-token-policies')
    )
  ...
  , options: ILoggerManagerRequestOptions = {}
    ...
    const req = get(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/logger/${namespace}/token-policies`)
    )
  ...
  , options: ILoggerManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/logger/${namespace}/token-policies/write-token-required`)
    , json(val)
    )
  ...
  , options: ILoggerManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/logger/${namespace}/token-policies/read-token-required`)
    , json(val)
    )
  ...
  , options: ILoggerManagerRequestOptions = {}
    ...
    const req = put(
      ...this.getCommonTransformers(options)
    , appendPathname(`/admin/logger/${namespace}/token-policies/delete-token-required`)
    , json(val)
    )
